 ...
 * Crear una Base de Datos con la siguiente instruccion **create database bd-oo2spring;** 
 ...
 * Configurar las variables de entorno para que el archivo application.properties las reconozca antes de iniciar la aplicacion:
   ...
   * DB_USERNAME -> colocar tu usuario de la base de datos (por default es "root")
   * DB_PASSWORD -> colocar tu password de la base de datos (por default es "root" pero es determinado por el usuario si este lo cambio al momento de la instalacion)
